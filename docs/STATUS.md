...
| Variáveis do app | `NEXT_PUBLIC_API_BASE` (Railway), `NEXT_PUBLIC_DEMO_HASH` (`0SVal1OCE4IHpiRHo-rsNA`), `NODE_ENV`; `GIT_COMMIT_SHA` em build (fallback `dev`, `next.config.ts:7`) |
