...
export function AuthNav({ dark = true }: { dark?: boolean }) {
  ...
  const cls = `inline-flex min-h-[44px] items-center gap-1.5 rounded-button px-2.5 text-[0.95rem] font-bold underline underline-offset-4 ${dark ? "text-paper hover:bg-white/10" : "text-teal-deep hover:bg-teal-soft"}`;
  ...
  return (
    <nav aria-label="Sua conta" className="flex items-center gap-1">
